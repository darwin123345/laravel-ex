...
<div class="container">
    <div class="row">
        <div class="col-md-9">
           ...
           <img style="width:100%"src="image/CCS.png">
                <div class="panel-body">
                @include('inc.ccslider')
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div class="panel-body"> 
                     <font color="green"> <center><h4><p>College of Computer Studies</p> </h4></center></font>
                    <ul >
                        <li><a href="/ccsMav">Mission and Vision</a></li>
                    </ul>  
                </div> 
            </div>
            <div class="panel panel-default">
