    ...
    <div class="row">
        <div class="col-md-9">
            <div class="panel panel-default">
              <img style="width:100%"src="image/CBA.png"/>
                <div class="panel-body">
               @include('inc.cbaslider')
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div class="panel-body"> 
                 <font color="green"><center> <h4><p>College of Business and Accountancy</p> </h4></center></font>
                    <ul >
                        <li><a href="/cbaMav">Mission and Vision</a></li>
                    </ul>  
                </div> 
            </div>
            <div class="panel panel-default">
