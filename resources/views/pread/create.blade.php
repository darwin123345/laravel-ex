        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                   ...
                   {!! Form::open(['action' => 'PreAdmissionController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                ...
                <legend>Home Address</legend>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="">Academic Track</label>
                        ...
                        <script>
                            $(document).ready(function() {
                                ...
                                $.get('/prea/' + cat_id , function(data){
                                    //success data
                                    console.log(data);
                                    $('#course_id').empty();

                                    $.each(data,function(index,subcatObj){
                                        $('#course_id').append("<option id='course_id' name='course_id' value='"+ subcatObj.id +"'>"+ subcatObj.name +"</option>");
                                    });
                                });
                            });
                            });
